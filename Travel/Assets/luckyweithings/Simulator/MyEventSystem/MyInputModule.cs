...
namespace Luckywei
{
    public class MyInputModule : MyPointerInputModule
    {
#if UNITY_EDITOR
        ...
        public override void UpdateModule()
        {
            ...
            m_MousePosition = MyInput.mousePosition;
        }

        public override bool IsModuleSupported()
        {
            return m_ForceModuleActive || MyInput.mousePresent || MyInput.touchSupported;
        }
        ...
        public override void ActivateModule()
        {
            base.ActivateModule();
            m_MousePosition = MyInput.mousePosition;
            m_LastMousePosition = MyInput.mousePosition;
